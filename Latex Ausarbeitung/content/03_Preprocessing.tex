...
We approach preprocessing in two steps. In the first step we clean the data set\todo{data set vereinheitlichen} based on knowledge we obtained in the \todo{verlinken} Data Understanding section and further analysis. 
